...
int main()
{
    ...
    ImGuiManager::Params pm{ .camera = cam, .p_window = window.get(),
    	.translateSquareOne = translateSquareOne, .translateSquareTwo = translateSquareTwo, .translateTriangle = translateTriangle };
    do {
        ...
        constexpr double angle(glm::radians(90.0));  
