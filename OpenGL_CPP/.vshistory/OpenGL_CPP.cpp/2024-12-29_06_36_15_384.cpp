...
int main()
{
	...
	do {
		...
		// First render the colored cubes/triangle
		shader1.Activate();
		...
		glm::mat4 MVPOne = cam.GetProjectionMatrix() * cam.GetViewMatrix() * ModelSquareOne;

		auto ModelSquareTwo = glm::mat4(1.0f);
		ModelSquareTwo = translate(ModelSquareTwo, translateSquareTwo);
		glm::mat4 MVPThree = cam.GetProjectionMatrix() * cam.GetViewMatrix() * ModelSquareTwo;
		...
		glm::mat4 MVPTwo = cam.GetProjectionMatrix() * cam.GetViewMatrix() * ModelTriangle;
		...
		glm::mat4 view = glm::mat4(glm::mat4(lookAt(*cam.m_cameraPos, *cam.m_cameraPos + *cam.m_cameraFront, *cam.m_cameraUp)));
