...
int main()
{
	...
	do {
		...
		VertexBuffer vertexBufferTriangle(s_VertexBufferDataCube, sizeof(s_VertexBufferDataCube));  // Using cube data for triangle
		...
		// Triangle (should use triangle vertex data, not cube data)
